...
class SlurmClusterManager():
    def __init__(self, num_param_servers=1, num_workers=None, default_starting_port=None):
        ...
        if num_workers is None:
            # What happens to nWorkers once they 
            self.nWorkers = self.nprocs - self.nPS # default to all other nodes doing something
    ...
    def build_cluster_spec(self):
        ...
        #                              'ps': ps_strings})
        spec_dictionary = {'worker': wk_strings,
                           'ps': ps_strings}
        ...
        # Return it all!  :D
        return spec_dictionary, job, task_id
